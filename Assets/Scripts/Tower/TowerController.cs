...
public sealed class TowerController
{
    ...
    public bool TryPlaceFromPalette(PaletteCubeDescriptor descriptor, Vector2 screenPoint)
    {
    ...
    public bool TryStackFromPalette(PaletteCubeDescriptor descriptor, Vector2 screenPoint)
    {
        if (_vm.HeightLocked.Value)
        {
            _messageController.Enqueue(LocalizationMessageKey.HeightLimitReached);
